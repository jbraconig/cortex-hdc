...
func (c *telemetryServiceClient) ReportAnomaly(ctx context.Context, in *AnomalyReportRequest, opts ...grpc.CallOption) (*AnomalyReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnomalyReportResponse)
	err := c.cc.Invoke(ctx, TelemetryService_ReportAnomaly_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TelemetryService_ReportAnomaly_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnomalyReportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelemetryServiceServer).ReportAnomaly(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelemetryService_ReportAnomaly_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).ReportAnomaly(ctx, req.(*AnomalyReportRequest))
	}
...
var TelemetryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cortex.telemetry.v1.TelemetryService",
	...
	Metadata: "api/proto/v1/telemetry.proto",
}
